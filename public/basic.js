...
var Notifier = null,ICN={'film':'glyphicon glyphicon-film','tele':'glyphicon glyphicon-phone-alt','trash':'glyphicon glyphicon-trash',settings:'glyphicon glyphicon-cog',wrench:'glyphicon glyphicon-wrench',tright:'glyphicon glyphicon-triangle-right',tleft:'glyphicon glyphicon-triangle-left',voption:'glyphicon glyphicon-option-vertical',hoption:'glyphicon glyphicon-option-horizontal',off:'glyphicon glyphicon-off',save:'glyphicon glyphicon-save',pencil:'glyphicon glyphicon-pencil',tower:'glyphicon glyphicon-tower',ok:'glyphicon glyphicon-ok',cok:'glyphicon glyphicon-ok-circle',plus:'glyphicon glyphicon-plus',user:'glyphicon glyphicon-user',folder:'glyphicon glyphicon-folder-close',home:'glyphicon glyphicon-home',remove:'glyphicon glyphicon-remove',edit:'glyphicon glyphicon-edit',ques:'glyphicon glyphicon-question-sign',check:'glyphicon glyphicon-check',handup:'glyphicon glyphicon-hand-up',thumbsup:'glyphicon glyphicon-thumbs-up',thumbsdown:'glyphicon glyphicon-thumbs-down',cloudupload:'glyphicon glyphicon-cloud-upload',tent:'glyphicon glyphicon-tent',leaf:'glyphicon glyphicon-leaf',refresh:'glyphicon glyphicon-refresh',record:'glyphicon glyphicon-record',copy:'glyphicon glyphicon-copy',paste:'glyphicon glyphicon-paste',screenshot:'glyphicon glyphicon-screenshot',asterisk:'glyphicon glyphicon-asterisk',cloud:'glyphicon glyphicon-cloud',book:'glyphicon glyphicon-book',infosign:'glyphicon glyphicon-info-sign',calendar:'glyphicon glyphicon-calendar',comment:'glyphicon glyphicon-comment',stats:'glyphicon glyphicon-stats',alerti:'glyphicon glyphicon-alert',savefile:'glyphicon glyphicon-save-file',music:'glyphicon glyphicon-music',cplay:'glyphicon glyphicon-play-circle',play:'glyphicon glyphicon-play',download:'glyphicon glyphicon-download-alt',mapmark:'glyphicon glyphicon-map-marker',oksign:'glyphicon glyphicon-ok-sign',link:'glyphicon glyphicon-link',lock:'glyphicon glyphicon-lock',list:'glyphicon glyphicon-list-alt',estar:'glyphicon glyphicon-star-empty',star:'glyphicon glyphicon-star',file:'glyphicon glyphicon-file'},INC={clock:'bi bi-clock',list:'bi bi-list',list2:'bi bi-list-nested',list3:'bi bi-list-columns-recverse',fclock:'bi bi-clock-fill',esmile:'bi bi-emoji-smile',efsmile:'bi bi-emoji-smile-fill',lfcarrow:'bi bi-left-circle-fill',rfcarrow:'bi bi-right-circle-fill',larrow:'bi bi-arrow-left',rarrow:'bi bi-arrow-right',rparrow:'bi bi-arrow-repeat',lrarrow:'bi bi-arrow-left-right',lbarrow:'bi bi-arrow-bar-left',rbarrow:'bi bi-arrow-bar-right',arrowdf:'bi bi-arrow-down-square-fill',printer:'bi bi-printer',fprinter:'bi bi-printer-fill',power:'bi bi-power',personx:'bi bi-person-x',aperson:'bi bi-person-plus',faperson:'bi bi-person-plus-fill',fpersonx:'bi bi-person-x-fill',huricane:'bi bi-hurricane',people:'bi bi-people',person:'bi bi-person',cperson:'bi bi-person-circle',fpeople:'bi bi-people-fill',server:'bi bi-server',shield:'bi bi-shield',cshield:'bi bi-shield-check',cfshield:'bi bi-shield-fill-check',fshield:'bi bi-shield-fill',trophy:'bi bi-trophy',ftrophy:'bi bi-trophy-fill',xcircle:'bi bi-x-circle',fxcircle:'bi bi-x-circle-fill',x:'bi bi-x',xlg:'bi bi-x-lg',txtarea:'bi bi-textarea',sticky:'bi bi-stickies',fsticky:'bi bi-stickies-fill',stick:'bi bi-sticky',fsticky:'bi bi-sticky-fill',stack:'bi bi-stack',stacko:'bi bi-stack-overflow',chkperson:'bi bi-person-check',persons:'bi bi-person-square',personf:'bi bi-person-lines-fill',personrd:'bi bi-person-rolodex',personws:'bi bi-person-workspace',personv:'bi bi-person-video2',personbb:'bi bi-person-bounding-box',fchkperson:'bi bi-person-check-fill',daperson:'bi bi-person-dash',fdaperson:'bi bi-person-dash-fill',minode:'bi bi-node-minus',fminode:'bi bi-node-minus-fill',plus:'bi bi-plus',plnode:'bi bi-node-plus',fplnode:'bi bi-node-plus-fill',mortarb:'bi bi-mortarboard',fmortarb:'bi bi-mortarboard-fill',jplus:'bi bi-journal-plus',jminus:'bi bi-journal-minus',jcheck:'bi bi-journal-check',fow:'bi bi-foward',ffow:'bi bi-foward-fill',lboxa:'bi bi-box-arrow-in-left',rboxa:'bi bi-box-arrow-in-right',checkc:'bi bi-check-circle',checkf:'bi bi-check-circle-fill',book:'bi bi-book',hbook:'bi bi-book-half',fbook:'bi bi-book-fill',bookm:'bi bi-bookmark',cbookm:'bi bi-bookmark-check',fbookm:'bi bi-bookmark-fill',griph:'bi bi-grip-horizontal',gripv:'bi bi-grip-vertical',medium:'bi bi-medium',phone:'bi bi-phone',phonef:'bi bi-phone-fill',phonel:'bi bi-phone-landscape',phonelf:'bi bi-phone-landscape-fill',signp:'bi bi-signpost',signpf:'bi bi-signpost-fill',signp2:'bi bi-signpost-2',signp2f:'bi bi-signpost-2-fill',slack:'bi bi-slack',viewl:'bi bi-view-list',views:'bi ib-view-stacked',bwidth:'bi bi-border-width',bank:'bi bi-bank',bank2:'bi bi-bank2',calendar:'bi bi-calendar',fcalendar:'bi bi-calendar-fill',rcalendar:'bi bi-calendar-range',frcalendar:'bi bi-calendar-range-fill',wcalendar:'bi bi-calendar4-week',ccalendar:'bi bi-calendar-check',fcccalendar:'bi bi-calendar-check-fill',dtcalendar:'bi bi-calendar-date',fdtcalendar:'bi bi-calendar-date-fill',dycalendar:'bi bi-calendar-day',fdycalendar:'bi bi-calendar-day-fill',ecalendar:'bi bi-calendar-event',fecalendar:'bi bi-calendar-event-fill',cardhead:'bi bi-card-heading',cardcheck:'bi bi-card-checklist',cardlist:'bi bi-card-list',command:'bi bi-command',malign:'bi bi-align-middle',app:'bi bi-app',appin:'bi bi-app-indicator',barstep:'bi bi-bar-chart-steps',pcloud:'bi bi-cloud-plus',fpcloud:'bi bi-cloud-plus-fill',lock:'bi bi-lock',flock:'bi bi-lock-fill',activity:'bi bi-activity',geo:'bi bi-geo',geof:'bi bi-geo-fill',geoalt:'bi bi-geo-alt',fgeoalt:'bi bi-geo-alt-fill',chatd:'bi bi-chart-dotted',pencil:'bi bi-pencil',fpencil:'bi bi-pencil-fill',pen:'bi bi-pen',fpen:'bi bi-pen-fill',pencils:'bi bi-pencil-square',house:'bi bi-house',fhouse:'bi bi-house-fill',image:'bi bi-image',fimage:'bi bi-image-fill',speedometer:'bi bi-speedometer',images:'bi bi-images',aimage:'bi bi-image-alt',film:'bi bi-film',efilep:'bi bi-file-earmark-person',credcard:'bi bi-credit-card',cart:'bi bi-cart',cart2:'bi bi-cart2',cart3:'bi bi-cart3',cart4:'bi bi-cart4',cartc:'bi bi-cart-check',cartcf:'bi bi-cart-check-fill',cartp:'bi bi-cart-plus',cartpf:'bi bi-cart-plus-fill',cartdf:'bi bi-cart-dash-fill',cartx:'bi bi-cart-x',cartxf:'bi bi-cart-x-fill',cartf:'bi bi-cart-fill',cartd:'bi bi-cart-dash',cash:'bi bi-cash',cashs:'bi bi-cash-stack',envelope:'bi bi-envelope',envelopef:'bi bi-envelope-fill',envelopeat:'bi bi-envelope-at',tele:'bi bi-telephone',telef:'bi bi-telephone-fill',telefw:'bi bi-telephone-foward',teleff:'bi bi-telephone-foward-fill',telei:'bi bi-telephone-inbound',teleif:'bi bi-telephone-inbound-fill',telep:'bi bi-telephone-plus',telepf:'bi bi-telephone-plus-fill',telem:'bi bi-telephone-minus',telemf:'bi bi-telephone-minus-fill',teleo:'bi bi-telephone-outbound',teleof:'bi bi-telephone-outbound-fill',telex:'bi bi-telephone-x',telexf:'bi bi-telephone-x-fill',togon:'bi bi-toggle-on',togof:'bi bi-toggle-off',right_chev:'bi bi-chevron-right',tog2on:'bi bi-toggle2-on',tog2of:'bi bi-toggle2-off',togs:'bi bi-toggles',togs2:'bi bi-toggles2',send:'bi bi-send',sendf:'bi bi-send-fill'},A1=['lg','md','sm','xs'],bets=('a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z').split(','),CC1=['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'],CC2=['January','February','March','April','May','June','July','August','September','October','November','December'],scriptcall=false,UB='';
	...
	function $$$(e,i,c,at,y){
		...
		attme(d,at);
		if(y)if(typeof y=='object'){feedme(d,y);}else{d.innerHTML=y;}
		return d;
	}
	...
	var phul=function(ar,ra,as,vl,ob,ns){
		var ul=colbox('phul',12,12,12,12),b={},f={},c,k,m,eo={e:ul,o:b,a:f,f1:myf1},d,v,q,s;addclass(ul,'form');
		for(var i in ar){
			v=(ra&&ra[i])?ra[i]:'';
			k=(as&&as[i])?as[i]:'text';
			c=(ob&&ob[ar[i]])?obinput({o:ob[ar[i]],at:{placeholder:ar[i]}}):{i:(k.toLowerCase()=='gender')?select(cto(['male','female']),'','form-control').e:input(ar[i],'form-control tright',{placeholder:ar[i],type:k,name:k})};
	...
	var modal=(o)=>{
		var hd=$$$('header','','flex justify-between','',[DIV('','','',o.hd),but([$$$('i','xmod','bi bi-x font25')],'','xmod','inline-flex items-center justify-center w-6 h-6 text-gray-400 transition-colors duration-150 rounded dark:hover:text-gray-200 hover: hover:text-gray-700')]),ws=DIV('modal-ws','modal-ws text-sm text-gray-700 dark:text-gray-400','',o.ws),md=DIV('','mt-4 mb-6','',[ws]),mm=DIV('modal','w-full px-6 py-4 overflow-hidden bg-white rounded-t-lg dark:bg-gray-800 sm:rounded-lg sm:m-4 sm:max-w-xl',{'x-transition:enter':"transition ease-out duration-150",'x-transition:enter-start':"opacity-0 transform translate-y-1/2",'x-transition:enter-end':"opacity-100",'x-transition:leave':"transition ease-in duration-150",'x-transition:leave-start':"opacity-100",'x-transition:leave-end':"opacity-0  transform translate-y-1/2",role:"dialog",style:''},[hd,md,$$$('footer','','flex flex-col items-center justify-end px-6 py-3 -mx-6 -mb-4 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800','',[but((o.k2)?o.k2:'Cancel','','mkey2','w-full px-5 py-2 text-sm font-medium leading-5 text-white text-gray-700 transition-colors duration-150 border border-gray-300 rounded-lg dark:text-gray-400 sm:px-4 sm:py-2 sm:w-auto active:bg-transparent hover:border-gray-500 focus:border-gray-500 active:text-gray-500 focus:outline-none focus:shadow-outline-gray'),but((o.k1)?o.k1:'Submit','','mkey1','w-full px-5 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple')])]),rd=DIV('xmod','fixed inset-0 z-30 flex items-end bg-black bg-opacity-50 sm:items-center sm:justify-center',{'x-transition:enter':"transition ease-out duration-150",'x-transition:enter-start':"opacity-0",'x-transition:enter-end':"opacity-100",'x-transition:leave':"transition ease-in duration-150",'x-transition:leave-start':"opacity-100",'x-transition:leave-end':"opacity-0",style:''},[mm]),eo={e:rd,fx:myfx},val=true;function myfx(v){X(rd);if(v&&o.fx)o.fx();};function myf1(){o.f1();};function myf2(){};addEvent(rd,'keydown',(v)=>{var e=v.code,ev=v.key;if(e=='Enter'||ev=='Enter')myf1();if(ev=='Escape'||e=='Escape')myfx();});addEvent(rd,'click',(e)=>{e=ee(e);if(e.id=='xmod')myfx();if(e.id=='mkey2')myfx(true);if(e.id=='mkey1')myf1();});return eo;
	}
	var phul2=function(ar,ra,as,vl,ob,ns,tp,tc){
		var ul=$$$('form'),rd=DIV('widthun','','',[ul]),wc=1,b={},f={},c,k,m,eo={e:rd,o:b,a:f,f1:myf1,f2:myf2},d,v,q,s,w,x,so;
		for(var i in ar){
			v=(ra&&ra[i])?ra[i]:'';
			k=(as&&as[i])?as[i]:'';x='input-'+wc;if(k.toLowerCase()=='category')so=prov;if(k.toLowerCase()=='location')so=loca;if(k.toLowerCase()=='gender')so=['male','female'];
			q=$$$('label',(tc)?tc:'','form-label img-zoomin',{'for':x},v)
			c={i:(k.toLowerCase()=='gender')?select(cto(['male','female']),x,'form-control').e:input(x,'form-control img-zoomin',{required:true,placeholder:ar[i],type:(k=='phone')?'number':k,name:k},(tp)?tp[i]:'')};if(k=='phone'){var g=phoneinput({p:ra[i],q:q});c.i=g.s;c.e=g.e}if(tp&&tp[i])c.i.style.height='10rem';
			m=(as&&(as[i]=='number'||as[i]=='phone')&&vl&&vl[i])?parse(vl[i]):'';if(vl&&!m)m=vl[i];
			c.i.value=(vl)?m:'';
			d=DIV('','animated zoomIn form-floating mb-2','',(k=='phone')?[((c.e)?c.e:c.i)]:[((c.e)?c.e:c.i),q])
			APP(ul,d);
			b[ar[i]]=c.i;
			f[ar[i]]=q;wc++;
		};if(ob)feedme(ul,ob);
		function myf1(o){
			for(var i in o){
				k=(ocn(ra))?'enter '+i:i;x='input-'+wc;o[i].id=x;
				q=$$$('label',(tc)?tc:'','form-label',{'for':x},v)
		...
		function myf2(v){feedme(ul,v);};
		
		return eo;
	}
	var phoneinput=(o)=>{
		var x=phones,q=(o&&o.q)?o.q:small().e,bt=but([span('NG','font11','me-1')],'button','','btn btn-light dropdown-toggle d-flex align-items-center cpi-drop',{'data-target':'#dropper','data-bs-toggle':'dropdown','aria-expanded':false}),ip=input('','form-control border-0 phone-input flex-shrink-1',{style:"outline: none;",pattern:"[0-9]+",required:true,minlength:"10",maxlength:"10",placeholder:(o&&o.p)?o.p:"Enter valid mobile number",type:'phone',name:'phone'}),x1=DIV('dropper','dropdown dropdown-menu w-100',{style:'max-height:10em;overflow:hidden scroll;position:unset'}),x2=DIV('','input-group mb-1 border rounded','',[bt,x1,span('+234','','input-group-text bg-white text-muted border-0 cpi-ext-txt'),ip]),x3=DIV('','cpi-input','',[x2,input('','country-code-input',{type:'hidden'})]),x4=DIV('','','',[$$$('form','','','',[x3])]),rd=DIV('','align-items-center justify-content-center w-100','',[x4]),eo={e:rd,s:ip,f1:myf1,f2:myf2};for(var i in x)APP(x1,myboy(i));function myf1(){return (!ip.value||parse(ip.value)==NaN||(bt.childNodes[0].textContent=='NG'&&ocn(parse(ip.value).toString())!=10))?'':'0'+ip.value;}function myf2(){return {n:myf1(),c:x[bt.childNodes[0].textContent]}};function myboy(v){var z=x[v],v1=but((z.name+' ('+z.dial_code+')'),'button','font11','dropdown-item',{'data-cpi-icon':v,'data-cpi-ext':z.dial_code,'data-cpi-min-length':"10",'data-cpi-max-length':"10"});addEvent(v1,'click',()=>{bt.click();});return v1;};return eo;
	}
	var signinput=(o)=>{
		var x=signs,q=(o&&o.q)?o.q:small().e,bt=but([span('NGN','font11','me-1')],'button','','btn btn-light dropdown-toggle d-flex align-items-center cpi-drop',{'data-target':'#dropper','data-bs-toggle':'dropdown','aria-expanded':false}),ip=input('','form-control border-0 phone-input flex-shrink-1',{style:"outline: none;",pattern:"",required:true,placeholder:(o&&o.p)?o.p:"Enter amount",type:'number',name:'&#8358;'}),x1=DIV('dropper','dropdown dropdown-menu w-100',{style:'max-height:10em;overflow:hidden scroll;position:unset'}),x2=DIV('','input-group mb-1 border rounded','',[bt,x1,span('&#8358;','','input-group-text bg-white text-muted border-0 cpi-ext-txt'),ip]),x3=DIV('','cpi-sign-input','',[x2,input('','country-code-input',{type:'hidden'})]),x4=DIV('','','',[$$$('form','','','',[x3])]),rd=DIV('','align-items-center justify-content-center w-100','',[x4]),eo={e:rd,s:ip,f1:myf1};for(var i in x)APP(x1,myboy(i));function myf1(){return (!ip.value||parse(ip.value)==NaN)?'':{s:ip.name,v:parse(ip.value)};};function myboy(v){var z=x[v],v1=but((z.currency+' ('+z.symbol+')'),'button','font11','dropdown-item',{'data-cpi-icon':v,'data-cpi-ext':z.symbol,'data-cpi-min-length':"8",'data-cpi-max-length':"9"});addEvent(v1,'click',()=>{bt.click();});return v1;};return eo;
	}
	var phoneinput2=(o)=>{
		var x=phones,q,bt=but([span('NG','font11','me-1')],'button','','btn btn-light mr-2 d-flex align-items-center cpi-drop',{}),ip=input('','form-control border-0 phone-input flex-shrink-1',{style:"outline: none;",pattern:"[0-9]+",required:true,minlength:"10",maxlength:"10",placeholder:"Enter valid mobile number",type:'phone',name:'phone'}),x1=DIV('dropper','collapse dropdown-menu w-100',{style:'max-height:10em;overflow:hidden scroll;'}),x2=DIV('','input-group mb-1 border rounded','',[bt,x1,span('+234','','input-group-text bg-white text-muted border-0 cpi-ext-txt'),ip]),x3=DIV('','cpi-input','',[x2,input('','country-code-input',{type:'hidden'})]),x4=DIV('','','',[$$$('form','','','',[x3])]),rd=DIV('','align-items-center justify-content-center w-100','',[x4]),eo={e:rd,s:ip,f1:myf1};for(var i in x)APP(x1,myboy(i));function myf1(){return (!ip.value||parse(ip.value)==NaN||(bt.childNodes[0].textContent=='NG'&&ocn(parse(ip.value).toString())!=10))?'':'0'+parse(ip.value);};function myboy(v){var z=x[v],v1=but((z.name+' ('+z.dial_code+')'),'button','font11','dropdown-item',{'data-cpi-icon':v,'data-cpi-ext':z.dial_code,'data-cpi-min-length':"8",'data-cpi-max-length':"9"});return v1;};return eo;
	}
	...
	var popmenu=(o)=>{
		var hx=hea(1,[strong('X','white','font25').e],'hov1','bred rad100'),kk=(o.k)?o.k:[icon2('bwidth','white','font17'),span('Toggle Dropdown','','sr-only')],bt=but(kk,'button','dropmkey','btn btn-md btn-link noline nopad'),ul=$$$('ul','bwhite','nopad'),bu=colbox('pad1',12,12,12,12,[center((o.hb)?[par('','mabot1'),hx,par('','mabot1'),o.hb,par('','mabot2'),ul]:[par('','height4'),hx,par('','mabot2'),ul]).e],'bwhite'),rd=DIV(o.id,'dropdown btn-group','',[bt]),eo={e:rd};rootstyle(hx,'width:1.3em;height:1.3em;');rootstyle(ul,'list-style:none');rootstyle(bu,'position:fixed;z-index:95;width:100%;height:100%;left:0;top:0;opacity:.95;float:none;overflow-y:scroll;');for(var i in o.a)APP(ul,myboy(i));function myf1(){if(fada(bu))return;APP(document.body,bu);};function myfx(){X(bu);};function myboy(v){var k=o.a[v],y0=(o.ic)?[par([icon2(o.ic[v],'white','font17'),small(' '+k,'white','font12').e],'nomargin')]:[par(k,'nomargin')],y1=$$$('li','height4','bg-dark text-light rad2 hov1 mabot1 animated zoomIn','',y0);rootstyle(y1,'padding-top:1em;');addEvent(y1,'click',()=>{myfx();o.fnc(k);});return y1;};if(o.pf&&o.hb)addEvent(o.hb,'click',()=>{o.pf();myfx();});addEvent(bt,'click',myf1);addEvent(hx,'click',myfx);return eo;
	}
	...
	var input=function(id,c,at,ta,vl,fn){
		var v=(ta)?'textarea':'input',rd=$$$(v,id,c,at,vl);if(ta)rd.style.minHeight='10em';if(fn)addEvent(rd,'input',()=>{if(rd.value<fn.l){rd.value=fn.l;return;};fn.f(rd.value);});addEvent(rd,'keydown',(v)=>{var e=v.key,ev=v.code;if(e=='Enter'||ev=='Enter'){v.preventDefault();}});return rd;
	}
	...
	var hea=function(c,tx,id,cl,at){
		var t='h'+c,a=$$$(t,id,cl);if(at)attme(a,at);if(typeof tx=='string'){a.innerHTML=tx;}else{feedme(a,tx);}return a;
	}
	...
	var par=function(tx,id,c,at){
		var p=$$$('p',id,c);attme(p,at);if(typeof tx!='object'){p.innerHTML=tx;}else{feedme(p,tx);};return p;
	}
	var anc=function(rf,cn,cl,id,ro){
		var a=$$$('a',id,cl);if(rf)a.href=rf;
		if(cn){if(typeof cn!='object'){a.innerHTML=cn}else{feedme(a,cn);}}
		attme(a,ro);
		return a;
	}
	var tanc=function(rf,cn,cl,id,ro){
		var a=$$$('a',id,cl);a.href=rf;if(cn){if(typeof cn!='object'){a.innerHTML=cn;}else{APP(a,cn);}}
	...
	var thed=function(id,c,a){
		...
		for(var i=1;i<a.length;i++){
			th=$$$('th','','text-center');th.innerHTML=a[i];APP(rd,th);
		}
		return rd;
	}
	var thed2=function(id,c,a){
		var rd=$$$('tr',id,c),th;
		for(var i=0;i<a.length;i++)APP(rd,$$$('td','','text-center','',[small(a[i],'').e]));
		return rd;
	}
	...
	var span=function(tx,id,c,at){
		var sp=$$$('span',id,c);
		attme(sp,at);
		if(typeof tx!='object'){sp.innerHTML=tx;}else{feedme(sp,tx);};return sp;
	}
	...
	var but=function(v,t,id,c,ro){
		...
		attme(d,ro);
		d.type=t;
		if(typeof v=='string'){d.innerHTML=v}else{for(var i in v)APP(d,v[i]);}
		return d;
	}
	...
	var xbut=function(id){
		return but([icon2('larrow',id)],'button',id,'line1 border-left-danger px-1 py-0 btn btn-xs red font25 m-2 mb-3 border-bottom-danger norad');
	}
	...
	var etab=function(id,at,cl,c){
		return $$$('table',id,(c)?c+' table-striped table-hover nomargin':'table-striped table-hover nomargin',at,cl);
	}
	...
	var flexnb=function(id,ct,bt,ag){
		...
		function flipme(t){
			if(!so){
				...
				if(t)sp.innerHTML=(id=='price')?barme(ip.value):ip.value;
				so=true;
			}else{
	...
	var small=(tx,id,c,at)=>{
		...
		(typeof tx=='string'||typeof tx=='number')?rd.innerHTML=tx:feedme(rd,tx);
		return eo;
	}
	var sup=(tx,id,c,at)=>{
	...
	var flashbox=(v,ia,r)=>{
		var h=small('Notice','blue').e,rd=colbox('nopad',3,2,4,11),eo={e:rd,f1:myf1},ks,it,x1,y=.8,zz={};APP(document.body,rd);
		rootstyle(rd,'position:fixed;overflow:hidden;z-index:99999999999999;right:.3em;top:3em;width:39%;');
		function myf1(v,ia,r){y=.5;var k='flash-'+datemap().key+(ocn(zz)+1),x1=sect('',((r)?'bg-danger':'bg-success')+' ohidden my-2 px-2 pt-3 widthun white animated zoomIn','',[par([strong([icon2((r)?'fminode':'fplnode','white')]).e,par([small(v,'white','font13').e],'nomargin','mx-2')],'pad2','d-flex')]),x2;zz[k]=x1;clg(k);APP(rd,x1);rootstyle(x1,'border-radius:.5em;overflow:hidden;z-index:99999999999999;box-shadow:.2em .5em .4em #bbba;transition:opacity:.4s;');x2=setTimeout(()=>{myfx(k);clearTimeout(x2);},90);clg(k);};function myfx(k){if(!zz[k])return;var it=(ia)?setInterval(()=>{y=y-(.1);zz[k].style.opacity=y;if(y<(.1))clearInterval(it);},100):'',x1=setTimeout(()=>{if(zz[k])X(zz[k]);delete zz[k];clearTimeout(x1);},3000);};return eo;
	...
	var selectpar=(o)=>{
		var a=select(o.a,'selector','font13 form-control dblock'),b=$$$('label',((o.i)?o.i:''),'form-label img-zoomin grey6',{'for':'selector'},o.t),rd=colbox('nopad',12,12,12,12,[$$$('form','','','',[DIV('','animated zoomIn form-floating mb-2','',[a.e,b])])]),eo={e:rd,s:a.e,f1:a.f1},w='';if(o.v)a.e.value=o.v;
		if(o.fnc){
			setInterval(()=>{if(w&&a.e.value==w)return;o.fnc(a.e.value);w=a.e.value;},50);
		}
		return eo;
	}
	var doublesel=(o,fn)=>{//{a:{},t1:tag1,t2:tag2}
		var a=sortOb(o.a),wx=cta(a)[0],b=a[wx],x1=selectpar({a:a,fnc:myf1,t:o.t1}),x2=selectpar({a:b,t:o.t2}),x3=par([x2.e]),x4=colbox('nopad',12,12,12,12,[x1.e],'mb-4'),x5=colbox('nopad',12,12,12,12,[,x3],'mb-2'),x6=colbox('pad5',12,12,12,12,[x4,x5]),rd=sect('','py-2','',[x6],'mabot1'),eo={e:rd,f1:myf1,f2:myf2};if(o&&o.v1){x1.s.value=o.v1;myf1(o.v1,o.v2);};function myf1(v,g){if(v==wx)return;wx=v;X(x2.e);b=a[v];x2=selectpar({a:b,t:o.t2});APP(x3,x2.e);if(g)x2.s.value=g;};function myf2(){return {s:x1.s.value,g:x2.s.value};};return eo;
	}
	var selul=(o,b,c)=>{
		var ul=$$$('ul','sel-ul'),rd=colbox('selul',12,12,12,12,[ul]),ct=1,li,eo={e:rd,f2:myf2,mk:myf3},ao={},ld,lo={};
	...
	var waiter=(t,fnc,xw)=>{
		var tx=(t)?t:'',uk=strong(tx).e,ub=par([uk],''),ps=strong(''),pp=par([ps.e],'waiter-tp'),tp=par([small(tx).e],'waiter-tp'),sp=DIV('','box1 spinner-border m-2 fw-bold font30',{role:'status',style:'border-width:medium;'}),sp2=DIV('','box1 spinner-grow m-2 fw-bold font30',{role:'status',style:'border-width:medium;'}),sp3=DIV('','box1 spinner-border m-2 fw-bold font30',{role:'status',style:'border-width:medium;'}),ux=par([DIV('','text-center','',[sp3]),ub,pp],'waiter-ux'),ku=(fnc)?[ux,br(),butgroup(1,[but('minimize','button','waiterkey','btn btn-md btn-primary')],'waiter-bg')]:[ux],rd=colbox((xw)?'waiter2':'waiter',12,12,12,12,[center(ku).e],'pt-5'),eo={e:rd,fp:myfp,f1:myf1},c=0,y=0,a=['red','black','green','gold','black','gold','red','black'],g=true;
		...
		setInterval(()=>{
			...
			styleme(sp,mrgar(['color'],[a[c]]));styleme(sp2,mrgar(['color'],[a[c]]));styleme(sp3,mrgar(['color'],[a[c]]));
			c++;
			(g)?y+=25:y-=25;
		},300);
	...
	var waiter2=(t,fnc,xw)=>{
		var tx=(t)?t:'',uk=strong(tx).e,ub=par([uk],''),ps=strong(''),pp=par([ps.e],'waiter-tp'),tp=par([small(tx).e],'waiter-tp'),sp=DIV('','box1 spinner-border m-2 fw-bold font30',{role:'status',style:'border-width:medium;'}),sp2=DIV('','box1 spinner-grow m-2 fw-bold font30',{role:'status',style:'border-width:medium;'}),sp3=DIV('','box1 spinner-border m-2 fw-bold font30',{role:'status',style:'border-width:medium;'}),ux=par([DIV('','text-center','',[sp3]),ub,pp],'','',{style:'overflow: hidden;color:#09387d;margin-top:8em;'}),ku=(fnc)?[ux,br(),butgroup(1,[but('minimize','button','waiterkey','btn btn-md btn-primary')],'waiter-bg')]:[ux],rd=colbox((xw)?'waiter2':'waiter',12,12,12,12,[center(ku).e],'pt-5'),eo={e:rd,fp:myfp,f1:myf1},c=0,y=0,a=['red','black','green','gold','black','gold','red','black'],g=true;
		//styleme(ub,mrgar(['width','height'],['5em','5em']));
		function myfp(o){
			ps.e.innerHTML=tx+' - '+o.p+'%';
		}
	...
	var accordian3=(x,hi)=>{
		var o=x.o,y=0,z=nuM,co=DIV('','accordion accordion-flush'),ws=sect('','','',(x.h)?[x.h,co]:[co]),rd=sect(x.id,'','',[ws]),eo={e:rd},oo={};for(var i in o)APP(co,myboy(i));if(hi)setTimeout(()=>{myf1();},900);function myf1(){return;for(var i in oo)oo[i].click();};function myboy(v){var vv=but(v,'button','bwhite','accordion-button collapsed',{style:'color:#000000cf;font-weight:bold;','data-toggle':'collapse','data-target':'#flush-collapse'+z[y],'aria-expanded':"false"}),v1=DIV('','accordion-item','',[hea(2,[vv],'flush-heading'+z[y],'accordion-header'),DIV('flush-collapse'+z[y],'accordion-collapse collapsed collapsing p-1 py-3','',(o[v].h)?[o[v].h,o[v].e]:[o[v].e])]);y++;if(hi)oo[v]=vv;return v1;};return eo;
	}
	var accordian4=(x,hi)=>{
		var o=x.o,y=0,z=nuM,co=DIV('','accordion accordion-flush'),ws=sect('','','',(x.h)?[x.h,co]:[co]),rd=sect(x.id,'','',[ws]),eo={e:rd},oo={};for(var i in o)APP(co,myboy(i));if(hi)setTimeout(()=>{myf1();},900);function myf1(){return;for(var i in oo)oo[i].click();};function myboy(v){var vv=but(v,'button','bwhite','accordion-button collapsed',{style:'color:#000000cf;font-weight:bold;','data-bs-toggle':'collapse','data-bs-target':'#flush-collapse'+z[y],'aria-expanded':"false"}),v1=DIV('','accordion-item','',[hea(2,[vv],'flush-heading'+z[y],'accordion-header'),DIV('flush-collapse'+z[y],'accordion-collapse collapsed collapsing p-1 py-3','',(o[v].h)?[o[v].h,o[v].e]:[o[v].e])]);y++;if(hi)oo[v]=vv;return v1;};return eo;
	}
	var iframe=(id,c,at)=>{
		var rd=$$$('iframe',id,c,at),eo={e:rd};return eo;
	}
	function iterate(k,c){
		var a=[];for(var i=0;i<parse(c);i++)a.push(k);return a;
	}
	var inputpar=(o)=>{
		var y=(o.k)?o.k:'inputer',x=(o.c)?o.c+' ':'',a=input(y,x+'form-control',{required:true,style:'padding-top:1.5em;',placeholder:o.t+'...',type:o.ty},(o.ta)?true:'',(o.v)?o.v:'',(o.fn)?o.fn:''),b=$$$('label',((o.i)?o.i:''),'form-label img-zoomin grey6',{'for':y},o.t),rd=colbox('nopad',12,12,12,12,[$$$('form','','','',[DIV('','animated zoomIn form-floating mb-2','',[a,b])])]),eo={e:rd,s:a,f1:myf1};function myf1(v){b.innerHTML=v;};if(o.v)a.value=o.v;
		return eo;
	}
	var progressbar=(v)=>{
	...
	var uploadbox=(v)=>{
		...
		UB=eo;rootstyle(rd,'position:fixed;overflow:hidden;z-index:999999;right:.5em;top:4em;box-shadow:.3em .3em .4em #bbba;padding:.5em padding-bottom:1em;transition:opacity:.4s;');
		function myfx(){
			ks=1;
			h.innerHTML='File Uploaded Successfully.';
			it=setInterval(()=>{ks-=.1;rd.style.opacity=ks;if(ks==0){X(rd);clearInterval(it);}},250)
	...
	var scrollkey=(o)=>{
		var rd=butgroup(3,[but([icon2('lboxa','prvbook','font15')],'button','prvbook','btn btn-xs btn-success width4'),but([icon2('rboxa','nxtbook','font15')],'button','nxtbook','btn btn-xs btn-success width4')],'greenboy-bg');
		
		function myf1(v){
			(!o.k)?(()=>{if(o.fnc)o.fnc(v);})():(()=>{var x1=mysiblin(o.o,o.k,v);o.fnc(x1);})();
		}
		
		
		addEvent(rd,'click',function(e){
			e=ee(e);
			if(e.id=='prvbook'||fada(e).id=='prvbook')myf1();
			if(e.id=='nxtbook'||fada(e).id=='nxtbook')myf1(true);
		});
		
		return rd;
	}
	var footer=(a)=>{
		var t=(a)?a:'',h=small(t,'grey').e,h2=small('','grey'),im=img('img/sflag.png','width5','dinline'),ut=DIV('width'),rd=DIV('footer',' py-2 credits text-center','',[center([ut,hea(5,[h],'nomargin'),hea(6,[h2.e],''),hea(6,[small('KARLDWORLD DESIGN ','text-gradient-2').e,sup(date('y'),'green').e],'nomargin')]).e]),eo={e:rd,f1:myf1,f2:myf2,f3:myf3},wc='';
		function myf1(v){
	...
	//Mon Apr 03 2023 20:52:32 GMT
	function rmvatt(el,k){if(!el||!k)return;
		el.removeAttribute(k);
	}
	function loadscripts(f){if(scriptcall)return;scriptcall=true;
		var sa=(f)?['client/js/main.js',"client/js/owl.carousel.min.js"]:['client/js/main.js',"client/js/owl.carousel.min.js"];for(var i in sa)APP(document.body,$$$('script','','',{src:sa[i]}));

	}
	function forbidexit(){
		window.addEventListener('beforeunload', function (e) {if(warn){e.preventDefault();clg(e);e.returnValue = '';return 'Please Click cancel if you are not attempting to close this page.';}else{clg('am off');};});function myf1(){alert('you are attempting to close this page');}
	}
	function forbidexit2(){
		window.onbeforeunload=null;
	}
	function unforbid(){
		window.removeEventListener('beforeunload',function (e) {e.preventDefault();clg(e);e.returnValue = '';return 'Please Click cancel if you are not attempting to close this page.';},true);
	}
	...
	function saleskey(){
		var a=datemap();return 'sales_'+a.d+'-'+(parse(a.m)+1)+'-'+a.y;
	}
	function scrollup(){
		window.scrollTo(0,0);
	}
	...
	function formatdate(d){
		var a=d.split(' '),b=a[0]+'-'+a[2]+'-'+a[1]+'-'+a[3],e=fixdate(a[4]),c={d:b,t:e};return c;
	}
	function timehour(t){if(!t)return '';
		var x=t.split(':'),r=(parse(x[0])>11)?'PM':'AM',a=(r=='PM')?(parse(x[0])-12):x[0],b=((a==0)?12:a)+' : '+x[1]+' '+r;return b;
	}
	function fixdate(d){
	...
	function datetext(d){if(!d)return '';
		var a=d.split('-'),b=parse(a[1])-1;return a[2]+ ' '+MMM[b]+' '+a[0]; 
	}
	function datesplit(tx){if(!tx)return '';
		var a=tx.split('-');return a[0]+' / '+a[1]+' / '+a[2]; 
	}
	function namecode(n){
	...
	function fetchvalu(o){
		var r={};
		for(var i in o)if(o[i].type=='phone'||o[i].name=='phone'){r[i]='0'+parse(o[i].value);}else if(o[i].type=='password'||o[i].type=='time'||o[i].type=='date'||o[i].type=='number'){r[i]=o[i].value;}else if(o[i].type=='username'||o[i].name=='username'||(o[i].placeholder&&o[i].placeholder.toLowerCase()=='name')||o[i].type=='gender'||o[i].name=='gender'||(o[i].placeholder&&o[i].placeholder.toLowerCase()=='gender')){r[i]=(spaceword(o[i].value))?spaceword(o[i].value):cleaname(o[i].value);}else if(o[i].type=='keyvalue'){r[i]=cleantxt(o[i].value);}else{r[i]=cleantxt(o[i].value);};
		return r;
	}
	function acronym(w){
	...
	function fileinfo(o){
		var dt=datemap(),k=o.name.split('.'),b='file-'+dt.key+('.'+k[ocn(k)-1]);clg({size:rnd(o.size/(1024*1024),2)+'MB',name:b,type:o.type,date:dt,kname:o.name});return {size:rnd(o.size/(1024*1024),2)+'MB',name:b,type:o.type,date:dt,kname:o.name}
	}
	...
	function validate(ul,at,fnc,sk){
		...
		for(var i in ul){
			if(!ul[i].value&&(!sk||!sk[i])){
				(i=='phone')?flash.f1('please enter phone number','',true):redtxt(at[i],('Enter '+i));
				if(vali)vali=false;
	...
	function resetkeys(r,a){
		for(var i in r)if(r[i].textContent!=a[i]){r[i].textContent=a[i];r[i].style.color='';}
	...
	function barme(t){
		if(!t)return '0.00';
		var y=(typeof t=='number')?unbar(t.toString()):unbar(t),j=y.split('.'),k=j[0],mi=(k.charAt(0)=='-')?'-':'',s=k,a=[],x,y,cx=s.length,st='';
		...
		for(var i in a)if(!(ocn(a[i])==1&&a[i]=='-')){st+=(((a[i].charAt(0)=='-')?a[i].replace('-',''):a[i])+',');}
		st=st.slice(0,st.length-1);
		return mi+st+((j[1])?'.'+j[1]:'.00');
	...
	function parseup(s){
		...
		var t=s;
		if(isfra(t)){
			var a=rnd(t,1);a=a.toString().split('.');a=(parse(a[1])>4)?parse(a[0])+1:a[0];
			parse(a);t=a;
		}
		return parseInt(t);
	}
	function parseup2(s){
		...
		var t=s;
		if(isfra(t)){
			var a=rnd(t,1);a=a.toString().split('.');a=parse(a[0])+1;
			parse(a);t=a;
		}
		return parseInt(t);
	}
	...
	function splitxt(t,x){
		var a=clonetxt(t),b=ocn(a),c=[],d,e;for(var i=0;i<b;i++){if(!ocn(a)){break;}else{d=a.slice(0,x);a=a.slice(x,b);c.push(d);};};return c;
	}
	function breaktxt(t){
	...
	function parse(s){if(!s)return 0;
		var t=s.toString();
	...
	function cloneo(a){
		var r=mrgar(Object.keys(a),Object.values(a));return r;
	}
	function sio(o,a,b){
		var o1={};
	...
	//c=element; o={'id':'gold',style:'color:red'}
	function attme(c,o){
		if(!o)return;
	...
	function datetxt(t){
		var a=t.split('-'),b=atme(a[0])+' '+CC2[parse(a[1])-1]+' '+a[2];return b;
	}
	function datetxt2(t){
		var a=t.split('-'),b=atme(a[0])+' '+CC1[parse(a[1])-1]+' '+a[2];return b;
	}
	function atme(p) {
		if(!p)return;
	...
	function pa(tx,id){
		var rd=DIV(id,'paradiv'),p=$$$('p','','para-p');p.innerHTML=tx;APP(rd,p);return rd;
	}
	function Inp(id){
